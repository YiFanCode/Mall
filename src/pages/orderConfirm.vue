<template>
    <div class="order-confirm">
        ...
        <modal modalType="middle" title="删除确认" btnType="1" @submit="submitAddress" @cancel="closeModal" :showModal="showDelModal">
            <template v-slot:body>
                <p>您确定要删除此地址吗？</p>
            </template>
        </modal>
                ...
                .addr-list{
                    ...
                    .addr-add{
                        ...
                        .icon-add{
                            ...
                            height: 30px;
                            border-radius: 50%;
                            background: #e0e0e0 url('/imgs/icon-add.png') no-repeat center;
